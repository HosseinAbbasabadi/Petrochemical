...
(dataColors = $("#revenue-report").data("colors")) && (colors = dataColors.split(","));
var options = {
    chart: {
        height: 265,
        type: "bar",
...
(chart = new ApexCharts(document.querySelector("#revenue-report"), options)).render();
colors = ["#3bafda", "#1abc9c", "#f672a7"];
(dataColors = $("#products-sales").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: {
        height: 265,
        type: "line",
...
(chart = new ApexCharts(document.querySelector("#products-sales"), options)).render();
...
(chart = new ApexCharts(document.querySelector("#projections-actuals"), options)).render(), $("#world-map-markers").vectorMap({
    map: "world_mill_en",
